...
1.  FastAPI project directory structure to minimize redundancies and improve modularization and readability
...
4.  Git for cooperation - how to integrate issue/commit template
